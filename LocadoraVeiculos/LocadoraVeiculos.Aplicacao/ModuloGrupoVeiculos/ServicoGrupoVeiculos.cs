...
namespace LocadoraVeiculos.Aplicacao.ModuloGrupoVeiculos
{
    public class ServicoGrupoVeiculos
    {
        ...
        public ServicoGrupoVeiculos(IRepositorioGrupoVeiculos repositorioGrupoVeiculos, IContext context)
        {
        ...
        public Result Excluir(GrupoVeiculos grupo)
        {
            ...
            {
                var msgErro = $"O Grupo de veículos {grupo.Nome} está relacionado com um " +
                    $"Plano de Cobrança/Veículo/Locação e não pode ser excluído";
