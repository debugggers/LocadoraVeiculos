...
namespace LocadoraVeiculos.Infra.BancoDados.TestesIntegracao.ModuloGrupoVeiculos
{
    ...
    public class RepositorioGrupoVeiculosEmBancoDadosTest
    {
        ...
        [TestMethod]
        public void Deve_inserir_novo_grupoveiculos()
        {
            //action
       ...
       //
       //     var repositorio = new RepositorioGrupoVeiculosEmBancoDados();
       //
       //     repositorio.Inserir(grupoVeiculos1);
       //     repositorio.Inserir(grupoVeiculos2);
       //     repositorio.Inserir(grupoVeiculos3);
       //
       //     //action
       //     var grupoVeiculos = repositorio.SelecionarTodos();
       //
       //     //assert
       ...
       //
       //     //action
       //     var grupoVeiculosExiste = _repositorio.GrupoVeiculosJaExiste("Suv");
       //
       //     //assert
